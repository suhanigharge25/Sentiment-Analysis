...
def apply_review_classification():
    ...
    # Encode ground truth labels consistently
    ground_truth_encoded = label_encoder.transform(ground_truth_labels)

    # Calculate metrics
    try:
        accuracy = accuracy_score(ground_truth_encoded, predicted_labels)
        precision = precision_score(ground_truth_encoded, predicted_labels, average='weighted')
        recall = recall_score(ground_truth_encoded, predicted_labels, average='weighted')
        f1 = f1_score(ground_truth_encoded, predicted_labels, average='weighted')
