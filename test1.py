...
def apply_preprocessing():
    # Display operation begin label in red
    begin_label.config(text="Performing Preprocessing", fg="red")
    root.update()
    ...
    for text in selected_text:
        # Your filtration logic here (e.g., removing URLs, special characters)
        filtered_text.append(text)  # Placeholder logic
    ...
    for text in filtered_text:
        ...
        stop_removed_text.append(' '.join(filtered_sentence))

    # Stemming
    ps = PorterStemmer()
    stemmed_text = []
    for text in stop_removed_text:
        word_tokens = word_tokenize(text)
    ...
    for text in stemmed_text:
        ...
        pos_tagged_text.append(' '.join([f"{word}/{tag}" for word, tag in tagged_sentence]))

    # Display the processed text in the text box
    processed_text = pos_tagged_text
    text_area.delete(1.0, tk.END)
    text_area.insert(tk.END, '\n\n'.join(processed_text))

    # Display operation end label in green
    begin_label.config(text="Preprocessing operation Complete", fg="green")
    root.update()
...
btn= Button(root, text="SELECT FILE", fg="white", bg="blue", activebackground="red", command=open_file)
btn.grid(row= 3, column= 0, padx=10, pady=10, sticky='nesw')

# Create a button for preprocessing
btn_preprocessing = Button(root, text="Preprocessing", fg="white", bg="blue", activebackground="red", command=apply_preprocessing)
btn_preprocessing.grid(row=4, column=0, padx=10, pady=10, sticky='nesw')

# Create a button for sentiment analysis operation
btn5= Button(root, text="SENTIMENT ANALYSIS", fg="white", bg="blue", activebackground="red", command=apply_sentiment_analysis)
btn5.grid(row= 5, column= 0, padx=10, pady=10, sticky='nesw')

# Create a button for review classification operation
btn7= Button(root, text="REVIEW CLASSIFICATION", fg="white", bg="blue", activebackground="red", command=apply_review_classification)
btn7.grid(row= 6, column= 0, padx=10, pady=10, sticky='nesw')

# Create a button for CNN classification operation
btn8= Button(root, text="CNN CLASSIFICATION", fg="white", bg="blue", activebackground="red", command=apply_cnn)
btn8.grid(row= 7, column= 0, padx=10, pady=10, sticky='nesw')

# Create a button for random forest classification operation
btn9 = Button(root, text="RANDOM FOREST CLASSIFICATION", fg="white", bg="blue", activebackground="red", command=apply_random_forest_classification)
btn9.grid(row=8, column=0, padx=10, pady=10, sticky='nesw')

# Create a button for fuzzy logic classification operation
btn10 = Button(root, text="FUZZYFICATION", fg="white", bg="blue", activebackground="red", command=apply_fuzzification)
btn10.grid(row=9, column=0, padx=10, pady=10, sticky='nesw')

# Create a button for hybridization operation
btn11 = Button(root, text="HYBRIDIZATION", fg="white", bg="blue", activebackground="red", command=hybridization)
btn11.grid(row=10, column=0, padx=10, pady=10, sticky='nesw')

# Create a button to exit the window
btn12 = Button(root, text="Exit", fg="white", bg="blue", activebackground="red", command=Close)
btn12.grid(row= 11, column= 0, padx=10, pady=10, sticky='nesw')
